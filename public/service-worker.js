const CACHE='church-v2-shell-9-v440';
const ASSETS=['/','/assets/styles.css?v=440','/assets/app.js?v=440','/assets/i18n.js?v=440','/assets/icon-192.png','/assets/icon-512.png','/manifest.webmanifest'];
