const CACHE='church-v2-shell-5';
const ASSETS=['/','/assets/styles.css','/assets/app.js','/assets/i18n.js','/assets/church-logo.png','/assets/icon-192.png','/assets/icon-512.png','/manifest.webmanifest'];
