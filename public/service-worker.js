const CACHE='church-v2-shell-14-v700';
const ASSETS=['/','/assets/styles.css?v=700','/assets/app.js?v=700','/assets/i18n.js?v=700','/assets/icon-192.png','/assets/icon-512.png','/manifest.webmanifest'];
