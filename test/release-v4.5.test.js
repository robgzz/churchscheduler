...
test('V4.5 admin page has a resilient non-module bootstrap loader',()=>{
  ...
  assert.match(html,/admin-loader\.js\?v=(?:4(?:5|6)0|5(?:00|10|20)|6(?:00|10)|70[01])/);
  assert.match(html,/Cargando administración/);
  assert.match(loader,/import\('\/assets\/admin\.js\?v=(?:4(?:5|6)0|5(?:00|10|20)|6(?:00|10)|70[01])'\)\.catch/);
