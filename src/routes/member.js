...
import { encryptPickupCode } from '../security/pickupCodeVault.js';
...
function safeChildCheckIn(row){const {pickupCodeHash,pickupCodeEncrypted,...safe}=row||{};return safe;}
