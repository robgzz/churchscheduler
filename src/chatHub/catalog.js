...
export const intentCatalog=Object.freeze([
  ...
  I('admin.memberSearch','admin',true,['busca a','buscar miembro','encuentra a','miembros','lista de miembros','dame la lista de todos los miembros','cuantos miembros hay','find member','search member','members','how many members','show members','list all members'],['memberSearch']),
  I('admin.memberProfileQuery','admin',true,['perfil de','dame el perfil de','muestrame el perfil de','datos de','ficha de','es administrador','es admin','tiene acceso de administrador','member profile','profile of','profile for','show the profile for','is administrator','is admin','has admin access'],['member','profile','role']),
  ...
  I('admin.memberDelete','admin',false,['elimina el perfil de','eliminar miembro','borra el perfil de','borra a','elimina a','delete member profile','delete member','remove member profile','delete the profile for'],['member','delete']),
  I('admin.memberEligibilityQuery','admin',true,['que ministerios tiene','que ministerios puede','en que ministerios puede servir','donde puede servir','puede cantar en','puede servir en','what ministries does','what ministries can','where can','can serve in','can sing in','show ministry eligibility','muestra elegibilidad ministerial'],['member','ministry','eligibility','query']),
  I('admin.memberEligibilityUpdate','admin',false,[
    'cambia los ministerios de','cambiar ministerios de','modifica los ministerios de','edita los ministerios de','actualiza los ministerios de','pon a','quita a','agrega a','asigna ministerio a','remueve ministerio de','puede servir en','no puede servir en','no debe servir en','no canta en','puede cantar en',
    'change ministries for','change the ministries for','update ministries for','edit ministries for','add ministry to','remove ministry from','make eligible for','make ineligible for','can serve in','cannot serve in','should not serve in','can sing in','do not schedule in'
  ],['member','ministry','eligibility','update']),
