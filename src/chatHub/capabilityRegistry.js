...
export const chatCapabilityRegistry=Object.freeze({
  ...
  'admin.console':C(null),'admin.programStatus':C('worship'),'admin.scheduleGenerate':C('worship','admin-write'),'admin.pendingSongs':C('worship'),'admin.memberSearch':C(null),'admin.memberCreate':C(null,'admin-write'),
