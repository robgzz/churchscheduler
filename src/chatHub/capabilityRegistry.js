...
export const chatCapabilityRegistry=Object.freeze({
  ...
  'assignments.mine':C('worship'),'program.query':C('worship'),'program.participation':C('worship'),'replacement.request':C('worship','self-write'),'availability.add':C('worship','self-write'),'songs.search':C('worship'),'songs.mine':C('worship'),'songs.status':C('worship'),'songs.history':C('worship'),
