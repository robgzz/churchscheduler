...
function intentLabel(id,locale='es'){
  const labels={
    ...
    'admin.memberSearch':['buscar miembros','search members'],'admin.memberCreate':['crear un miembro','create a member'],'admin.visitors.query':['consultar visitantes','view visitors'],'admin.eventRsvpList':['ver RSVP de un evento','view event RSVPs'],'admin.bulletinUpload':['subir un boletín','upload a bulletin'],'admin.announcementCreate':['crear un anuncio','create an announcement'],'admin.eventCreate':['crear un evento','create an event'],'admin.taskCreate':['asignar una tarea','assign a task'],'admin.tasks.query':['consultar tareas administrativas','check administrative tasks'],'admin.prayer.list':['ver todas las peticiones','view all prayer requests'],'admin.childrenStatus':['consultar Cuidado de Niños activo','check active Children Care'],'admin.reports.query':['consultar reportes','check reports'],'admin.communications.query':['consultar comunicaciones','check communications'],'admin.audit.query':['consultar auditoría','check audit history'],'admin.modules.query':['consultar módulos','check modules'],'admin.moduleToggle':['activar o desactivar un módulo','enable or disable a module']
  };
