...
@description('Scheduler and priority communication job cron in UTC. Runs every 15 minutes; application logic performs the Sunday 7 PM local schedule rollover safely across DST.')
